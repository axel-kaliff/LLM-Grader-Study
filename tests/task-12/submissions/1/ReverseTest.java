 ...
 *
 * @author Simon Larsén & Douglas Bengtsson
 * @version 2017-08-08 & 2019-12-05
 */
public class ReverseTest {
  ...
  public void reversedListIsEmptyWhenOriginalIsEmpty() {
    ...
    // Act
    List<Integer> reversed = reverse.reversed(original);
  ...
  public void reversedListIsEqualToOriginalWhenLengthIsOne() {
    // Arrange
    List<Integer> singleElementList = new ArrayList<Integer>(1);
